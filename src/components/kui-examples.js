    ...
    <div className="kui-examples-bg">
      <section className="ibm-grid-container kui-examples-container">
        ...
        <div className="ibm-grid-col-lg-16-4 ibm-grid-col-md-8-4 ibm-grid-col-sm-4-3">
          <h2 className="ibm-type-e">
            With Kui, you can save up to 5x of your time by running a single
            command.
          </h2>
        </div>
        ...
        <div className="ibm-grid-col-lg-16-14">
          <img
            className="kui-examples-image"
            src={tabsState.currentVideo}
            alt={tabsState.currentSubtitle}
            width="100%"
          />
...
export const Tab = ({ title, index, active, reference, subtitle, onClick }) => {
  return (
    ...
    >
      <a
        {...(active
          ? { "aria-selected": "true", className: "ibm-active" }
          : {})}
        role="tab"
        href={reference}
